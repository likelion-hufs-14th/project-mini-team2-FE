...
// 3. 공감(좋아요) 누르기
export const addFan = (feedId) => request(api.post(`/feeds/${feedId}/fan`), '공감 추가 실패:');

// 4. 비공감(싫어요) 누르기
export const addWood = (feedId) => request(api.post(`/feeds/${feedId}/wood`), '비공감 추가 실패:');
...
// 7. 방문 기록 생성
export const createVisitLog = () => request(api.post('/feeds'), '방문 기록 생성 실패:');
